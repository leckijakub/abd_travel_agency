...
from app.controllers.ReservationController import index, store, update, delete, create
...
reservation_bp.route('/delete/<int:reservation_id>', methods=['POST'])(delete)
reservation_bp.route('/create', methods=['POST'])(create)
